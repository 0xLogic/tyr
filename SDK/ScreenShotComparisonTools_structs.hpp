...
// Enum ScreenShotComparisonTools.EImageTolerancePreset
// NumValues: 0x0006
enum class EImageTolerancePreset : uint8
{
	IgnoreNothing                            = 0,
	IgnoreLess                               = 1,
	IgnoreAntiAliasing                       = 2,
	IgnoreColors                             = 3,
	Custom                                   = 4,
	EImageTolerancePreset_MAX                = 5,
};
...
public:
	...
	bool                                          IgnoreAntiAliasing;                                // 0x0006(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IgnoreColors;                                      // 0x0007(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaximumLocalError;                                 // 0x0008(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaximumGlobalError;                                // 0x000C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
