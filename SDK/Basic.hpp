...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0C895180;
	constexpr int32 AppendString      = 0x0144B2A0;
	constexpr int32 GNames            = 0x0C7B0F80;
	constexpr int32 GWorld            = 0x0C578E90;
	constexpr int32 ProcessEvent      = 0x0168B3C0;
